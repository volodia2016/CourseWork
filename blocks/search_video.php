...
<p id="nav_name">Пошук відеозаписів</p>
...
<div id="video_list">
	<div class="video_player">
	  <?php
	   	if ($_GET['search_video']) 
  			$url_decode = $_GET['search_video'];
  		$v = urldecode($url_decode);
  		echo 'Ви шукаєте "'.$v.'"'.".<br>";
        include 'functions.php';
        //$query = mysql_query("SELECT * FROM movies ");
        $charrus=mysql_query("set names 'cp1251'");
        $user_watch_video = $_SESSION['user_id'];
        $query = mysql_query("select * from movies where name like '%$v%'");
        ...
        else echo "Не було знайдено жодних відеозаписів.";
